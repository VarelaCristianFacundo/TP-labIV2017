...
class reservaApi extends Reserva implements IApiUsable
{
     ...
     public function TraerTodos($request, $response, $args) {
      ...
      public function CargarUno($request, $response, $args) {
        ...
        $miReserva->id_usuario=$id_usuario;
        $miReserva->local=$local;
        $miReserva->fecha=$fecha;
        $miReserva->cantidad=$cantidad;
        
        //$miReserva->Agregar();
        Reserva::Agregar($miReserva);
        
        //$response->getBody()->write("se guardo el cd");
        $objDelaRespuesta->respuesta="Se guardo la Reserva.";   
